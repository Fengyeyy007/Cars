...
<form action="UroleptreeAction!updper?perview.perviewId=${per.perviewId }" method="post" onSubmit="return subRole();">
  <table class="maintable" width="100%" border="0" cellspacing="0">
    <tr>
      <td width="104"><div align="right">权限编号：</div></td>
      <td height="24" colspan="2">${per.perviewId }</td>
      <input type="hidden" name="pid"  />
    </tr>
    <tr>
      <td width="104"><div align="right">权限：</div></td>
      <td height="24"><textarea name="perview.perviewName" id="roleDepict" >${per.perviewName }</textarea></td>
    <td height="24"></td>
    </tr>
