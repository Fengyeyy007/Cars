...
<form action="UroleptreeAction!adduser.action" method="post">
  <table class="maintable" width="100%" border="0" cellspacing="0">
    <tr>
      <td width="104"><div align="right">用户名：</div></td>
      <td width="201" height="24"><input name="us.loginName" type="text" class="inputcontent" id="username" size="20" onChange="checkUser()">        <span class="star">*</span></td>
    <td width="473"></td>
    </tr>
    <tr>
      <td width="104"><div align="right">用户密码：</div></td>
      <td height="24"><input name="us.loginPwd" type="password" class="inputcontent" id="password" size="20" maxlength="16" />        
    ...
    <tr>
      ...
      <td height="24"><input name="us.userName" type="text" class="inputcontent" id="name" size="20">
	  <span class="star">*</span></td>
    <td height="24"></td>
    </tr>
    <tr>
      <td width="104"><div align="right">角色：</div></td>
      <td height="24" colspan="2"><select name="uro.roleName" id="role">
        ...
        <option value="销售管理员">销售管理员</option>
      	...
      	<option value="统计管理员">统计管理员</option>
