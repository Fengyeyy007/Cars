...
<form action="CustomerAction!delFirms.action" method="post">
  <table class="tablelistcontent" width="100%" border="1" cellspacing="1">
    ...
    <c:forEach items="${firlist }" var="fir">
      <tr class=Off onMouseOut="this.className='Off'"
		onMouseOver="this.className='Up'">
        <td height="24"><div align="center">
            <input type="checkbox" name="tmps" value="${fir.firmId }">
        </div></td>
        <td><div align="center">${fir.firmId }</div></td>
        <td><div align="center">${fir.firmName }</div></td>
        <td><div align="center">${fir.firmPerson }</div></td>
        <td><div align="center">${fir.firmPhone }</div></td>
        <td><div align="center">${fir.firmZip }</div></td>
        <td><div align="center">${fir.firmAdds }</div></td>
        <td><div align="center"><a href="CustomerAction!queryFirmsById?firms.firmId=${fir.firmId }">修改</a></div></td>
      </tr>
      </c:forEach>
  </table>
  <table width="100%">
	<tr>
		<td height="40">
		  <div align="left">
		    <input type="button" name="firms.firmId"
			value="增加" onClick="window.location.href='../customer/addfactory.jsp'">
